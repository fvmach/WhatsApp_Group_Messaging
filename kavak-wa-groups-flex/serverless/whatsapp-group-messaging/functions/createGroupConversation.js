...
exports.handler = async function(context, event, callback) {
    ...
    console.log("[DEBUG ENV] Keys visible:", Object.keys(context).filter(k => k === "WHATSAPP_TEMPLATE_SID" || k === "TWILIO_FUNCTIONS_BASE_URL"));
    console.log("[DEBUG ENV] WHATSAPP_TEMPLATE_SID:", context.WHATSAPP_TEMPLATE_SID);
    console.log("[DEBUG ENV] TWILIO_FUNCTIONS_BASE_URL:", context.TWILIO_FUNCTIONS_BASE_URL);
